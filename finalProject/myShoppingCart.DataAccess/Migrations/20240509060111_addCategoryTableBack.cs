...
{
    /// <inheritdoc />
    public partial class addCategoryTableBack : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                columns: new[] { "categoryDesc", "categoryName", "createdAt" },
                values: new object[] { "training courses for cats", "cat", new DateTime(2024, 5, 9, 3, 9, 45, 517, DateTimeKind.Utc).AddTicks(476) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                columns: new[] { "categoryDesc", "categoryName", "createdAt" },
                values: new object[] { "training courses for small dogs", "dog(s)", new DateTime(2024, 5, 9, 3, 9, 45, 517, DateTimeKind.Utc).AddTicks(555) });
        }
    }
}
